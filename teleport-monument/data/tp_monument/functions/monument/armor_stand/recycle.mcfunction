...
execute positioned ~ ~1 ~ store success score @s tpm.temp run kill @e[type=glow_item_frame,distance=..0.1,tag=tp_monument,limit=1,sort=nearest]
...
function tp_monument:monument/item
forceload remove ~ ~ ~ ~